...
import (
	...
	"github.com/RishiBuilds/NoteRoot/internal/http/api"
	"github.com/RishiBuilds/NoteRoot/internal/http/middleware"
...
func NewRouter(wikiInstance *noteroot.NoteRoot) *gin.Engine {
