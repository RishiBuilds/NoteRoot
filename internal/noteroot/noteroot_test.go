...
import (
	...
	verrors "github.com/RishiBuilds/NoteRoot/internal/core/shared/errors"
)

func setupTestNoteRoot(t *testing.T) *NoteRoot {
	tempDir := t.TempDir()
	w, err := NewNoteRoot(tempDir, "admin", "secretkey")
	if err != nil {
		t.Fatalf("Failed to create NoteRoot: %v", err)
	}
	return w
}

func TestNoteRoot_CreatePage_Root(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_CreatePage_WithParent(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_CreatePage_EmptyTitle(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_CreatePage_ReservedSlug(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_CreatePage_PageExists(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_CreatePage_InvalidParent(t *testing.T) {
	w := setupTestNoteRoot(t)
	invalidID := "not-real"
...
func TestNoteRoot_GetPage_ValidID(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_GetPage_InvalidID(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_MovePage_Valid(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_DeletePage_Simple(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_DeletePage_WithChildren(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_DeletePage_Recursive(t *testing.T) {
	w := setupTestNoteRoot(t)
	parent, _ := w.CreatePage(nil, "Parent", "parent")
	_, _ = w.CreatePage(&parent.ID, "Child", "child")
...
func TestNoteRoot_UpdatePage(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_SuggestSlug_Unique(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_SuggestSlug_Conflict(t *testing.T) {
	w := setupTestNoteRoot(t)
	root := w.GetTree()
...
func TestNoteRoot_SuggestSlug_DeepHierarchy(t *testing.T) {
	tmpDir := t.TempDir()
	wiki, err := NewNoteRoot(tmpDir, "admin", "secretkey")
	if err != nil {
		t.Fatalf("Failed to initialize NoteRoot: %v", err)
	}
...
func TestNoteRoot_FindByPath_Valid(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_FindByPath_Invalid(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_SortPages(t *testing.T) {
	w := setupTestNoteRoot(t)
	parent, _ := w.CreatePage(nil, "Parent", "parent")
...
func TestNoteRoot_InitDefaultAdmin_UsesGivenPassword(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_ResetAdminUserPassword_ChangesPassword(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_Login_SuccessAndFailure(t *testing.T) {
	w := setupTestNoteRoot(t)
...
func TestNoteRoot_ResetAdminPasswordWithoutJWTSecret(t *testing.T) {
	tempDir := t.TempDir()

	// Verwende Dummy-Secret
	wiki, err := NewNoteRoot(tempDir, "supersecure", "")
	if err != nil {
		t.Fatalf("Failed to initialize NoteRoot: %v", err)
	}
	defer wiki.Close()
